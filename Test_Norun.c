...
int main(){ 
    ...
    printf("Please make sure to fullscreen the Command prompt if not.....\nPress Enter to start...\n");
    enter();
...
//Birthday Checker and Wishing
    if (date_DOB==tm.tm_mday && month_DOB==tm.tm_mon + 1)
    {
        ...
        printf("\nWe have a surprise for you :)\nPlease press enter after every message end.....\n");
        enter();
        enter();
        wish1();
        enter();
